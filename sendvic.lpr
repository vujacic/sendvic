;; -*- lisp-version: "10.1 [32-bit Windows] (Mar 15, 2017 20:26)"; -*-

(in-package :cg-user)

(define-project :name :sendvic
  :modules (list (make-instance 'module :name "prob.lsp")
                 (make-instance 'module :name "ZavrsetakIgre")
                 (make-instance 'module :name "Validacija")
                 (make-instance 'module :name "igra")
                 (make-instance 'module :name "ProveraSendvic.lisp")
                 (make-instance 'module :name "Potezi2.lisp")
                 (make-instance 'module :name "alfa-beta.lisp"))
  :projects nil
  :libraries nil
  :editable-files nil
